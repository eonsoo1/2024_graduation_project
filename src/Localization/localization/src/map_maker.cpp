...
int main(int argc, char** argv) {
    ...
    // OSM 파일 경로
    std::string osm_file_path = "/home/eonsoo/2024_graduation_project/src/Localization/localization/map/Monday3.osm";
    // 수정된 CSV 파일 경로
    std::string modified_csv_file_path = "/home/eonsoo/2024_graduation_project/src/Localization/localization/map/Monday3_xy.csv";
